'use server';
/**
 * @fileOverview Generates detailed explanations of cryptocurrency terms.
 *
 * - generateExplanation - A function that generates an explanation for a given term.
...
const GenerateExplanationInputSchema = z.object({
  term: z.string().describe('The cryptocurrency term to explain.'),
});
export type GenerateExplanationInput = z.infer<typeof GenerateExplanationInputSchema>;

const GenerateExplanationOutputSchema = z.object({
  explanation: z.string().describe('A detailed explanation of the cryptocurrency term.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert in cryptocurrency and Web3 terminology.  Provide a detailed explanation of the following term: {{{term}}}.`,
});
